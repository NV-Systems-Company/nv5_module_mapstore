...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_rows (
 ...
 bodytext_seo text,
 provinceid smallint(4) NOT NULL DEFAULT '0',
 districtid smallint(4) NOT NULL DEFAULT '0',
 wardid smallint(4) NOT NULL DEFAULT '0',
 street smallint(4) NOT NULL DEFAULT '0',
 address varchar(250) DEFAULT '',
 address_full varchar(250) DEFAULT '',
